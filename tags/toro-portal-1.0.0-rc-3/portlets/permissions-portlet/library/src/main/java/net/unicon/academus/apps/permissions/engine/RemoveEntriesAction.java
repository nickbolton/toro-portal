...
public final class RemoveEntriesAction extends PermissionsAbstractAction {
        ...
        if(decisions.length > 0){
            ...
            if (sel.length > 0) {                
                ...
                for (int i=0; i < sel.length; i++) {
                    ...
                    puc.removeCivisAccessEntry(entityId);
                }
            }
        }
    ...
    private RemoveEntriesAction(IWarlockFactory owner, Handle handle, String[] choices) {
