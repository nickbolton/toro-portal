...
public final class CancelChangesAction extends AbstractWarlockFactory
                                            .AbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
       ...
       return new SimpleActionResponse(screen, new InitialQuery((PermissionsUserContext)ctx));
    ...
    private CancelChangesAction(IWarlockFactory owner, Handle handle, String[] choices) {
