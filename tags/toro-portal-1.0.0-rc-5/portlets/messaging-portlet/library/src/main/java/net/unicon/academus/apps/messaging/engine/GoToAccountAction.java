...
public final class GoToAccountAction extends AbstractWarlockFactory
                                            .AbstractAction {
    ...
    public static IAction parse(Element e, IWarlockFactory owner)
        ...
        return new GoToAccountAction(owner, handle, choices);
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        //String id = decisions[0].getDecision("goLocation").getFirstSelectionHandle();

        MessagingUserContext muc = (MessagingUserContext)ctx;
        muc.clearMessageSelection();
        muc.clearFolderSelection();
        muc.resetViewMode();
        muc.setFactorySelection(muc.getFactory(id));
    ...
    private GoToAccountAction(IWarlockFactory owner, Handle handle, String[] choices) {
