...
public final class ChangeCredentialsAction extends AbstractWarlockFactory
                                            .AbstractAction {
    ...
    public void init(StateMachine m) {
        ...
        screen = m.getScreen(Handle.create("gateway_main"));
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        // Find the target.
        String id = decisions[0].getDecision("goToEntryPoint").getFirstSelectionHandle();
        id = id.replaceFirst("upcreds_", "");

        guc.setEntryId(id);
        guc.setChangeCreds(true);
    ...
    private ChangeCredentialsAction(IWarlockFactory owner, Handle handle, String[] choices) {
...
} // end ChangeCredentialsAction class
