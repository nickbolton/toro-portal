...
public final class ChangePermissionsSortAction extends PermissionsAbstractAction {
    ...
    private ChangePermissionsSortAction(IWarlockFactory owner, Handle handle,
                                String[] choices) {
