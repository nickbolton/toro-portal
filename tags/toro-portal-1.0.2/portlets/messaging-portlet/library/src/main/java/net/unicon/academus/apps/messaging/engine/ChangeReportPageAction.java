...
public final class ChangeReportPageAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        PagingState ps = muc.getDetailPref().getReportPageState();
        switch (change.toInt()) {
    ...
    private ChangeReportPageAction(IWarlockFactory owner, Handle handle,
