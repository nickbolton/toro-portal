...
/*  This allows user to obtain the current date and time from the database.  We assume you have postgres setup.

 *

*/

public class SqlServerTimeServiceImpl extends ADBTimeService {

    

    private static final String sysDateSQL = "SELECT getDate() as now";

    

    /** Constructor */

    public SqlServerTimeServiceImpl() { }
