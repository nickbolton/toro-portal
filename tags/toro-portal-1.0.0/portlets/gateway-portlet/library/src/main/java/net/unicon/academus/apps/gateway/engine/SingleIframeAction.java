...
public final class SingleIframeAction extends AbstractWarlockFactory
                                            .AbstractAction {
    ...
    private SingleIframeAction(IWarlockFactory owner, Handle handle, String[] choices) {
