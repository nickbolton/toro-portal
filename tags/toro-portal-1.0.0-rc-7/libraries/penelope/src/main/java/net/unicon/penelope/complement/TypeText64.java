 ...
 */
@Deprecated
public final class TypeText64 extends AbstractType {

    /*
     * Public API.
     */

    public static final TypeText64 INSTANCE = new TypeText64();
    ...
    public IComplement parse(Object o) {
        ...
        String s = (String) o;
        if (s.length() > 64) {
            String msg = "Argument 's [String]' cannot be longer than 64 "
                                                        + "characters.";
            throw new IllegalArgumentException(msg);
        }

        return new ComplementText64(s, this);

    }

    public IComplement fromByteArray(byte[] b) {
        return new ComplementText64(new String(b), this);
    }
    ...
    protected class ComplementText64 extends AbstractComplement {
        public ComplementText64(Object o, IComplementType t) {
            super(o, t);
        }
