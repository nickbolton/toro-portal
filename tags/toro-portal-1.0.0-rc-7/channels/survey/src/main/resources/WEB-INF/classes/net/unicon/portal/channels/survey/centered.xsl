...
<xsl:stylesheet xmlns:xsl='http://www.w3.org/1999/XSL/Transform' version='1.0'>
    ...
    <xsl:template match='page' name='form'>
        ...
        <table width='100%' cellpadding='3' cellspacing='0' class="centered">
            <xsl:if test='@title'>
                <tr>
            ...
            <xsl:for-each select="question">
                ...
                <tr>
                    <td align='center'>
                    	<!--UniAcc: Layout Table -->
                        <table cellpadding='3' cellspacing='0' class="survey-table">
                            <tr>
                                <td valign='top'>
                                	<!--UniAcc: Layout Table -->
                            ...
                            <xsl:for-each select='input'>
                                ...
                                <xsl:if test='string-length(normalize-space(text())) &gt; 0'>
                                    <tr>
                                        <td colspan='2' align='center' class='uportal-channel-text'>
                                            <xsl:value-of select='text()' />
                                        </td>
                                    </tr>
                                </xsl:if>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                ...
                <table cellpadding='3' cellspacing='0' border='1'>
                    <tr>
                        <td align='center' class='uportal-channel-text'>&#160;Not Applicable&#160;</td>
                    </tr>
                </table>
            </xsl:otherwise>
        </xsl:choose>
