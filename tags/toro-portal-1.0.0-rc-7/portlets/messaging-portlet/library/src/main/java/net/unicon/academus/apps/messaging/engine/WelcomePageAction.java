...
public final class WelcomePageAction extends AbstractWarlockFactory
                                            .AbstractAction {
    ...
    public void init(StateMachine m) {
        ...
        screen = m.getScreen(Handle.create("message_welcome"));
    }
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
       ...
       return new SimpleActionResponse(screen, new InitialQuery((MessagingUserContext)ctx));
    ...
    private WelcomePageAction(IWarlockFactory owner, Handle handle, String[] choices) {
