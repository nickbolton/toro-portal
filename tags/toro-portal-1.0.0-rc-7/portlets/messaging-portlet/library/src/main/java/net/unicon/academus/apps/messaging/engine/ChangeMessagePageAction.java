...
public final class ChangeMessagePageAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        PagingState ps = muc.getMessagePaging();
        switch (change.toInt()) {
    ...
    private ChangeMessagePageAction(IWarlockFactory owner, Handle handle,
