...
public final class GoBackFolderAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        Location location = user.getHistory().goBack();
        user.setDriveSelection(location.getDrive());
    ...
    private GoBackFolderAction(IWarlockFactory owner, Handle handle,
                                            String[] choices) {
