...
public class GuaranteedActionStrict extends GuaranteedActionImpl {
    ...
    public GuaranteedActionStrict(String name, long timeLimit, SimpleBlock action) {
        this(name, timeLimit, action, false);
    }

    public GuaranteedActionStrict(String name, long timeLimit, SimpleBlock action, boolean killActionThread) {
    ...
    public String toString() {
        return "GuaranteedActionStrict " + number;
    }
    ...
    protected void startThreads() {
        ...
        timeLimitThread.setEndTime(actionStartTime + timeLimit);
