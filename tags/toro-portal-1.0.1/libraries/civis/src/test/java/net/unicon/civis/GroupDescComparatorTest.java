...
public class GroupDescComparatorTest extends TestCase {
	/*
	 * Test method for 'net.unicon.civis.GroupDescComparator.compare(Object, Object)'
	 */
	public void testCompare() {
		
		IGroup g1 = new MockGroup("filename.txt");

		GroupDescComparator c = new GroupDescComparator();
