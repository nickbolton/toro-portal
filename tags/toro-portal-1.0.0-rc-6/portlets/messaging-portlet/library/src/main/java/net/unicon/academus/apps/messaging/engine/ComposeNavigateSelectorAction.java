...
public final class ComposeNavigateSelectorAction extends AbstractWarlockFactory
                                            .AbstractAction {
    ...
    public static IAction parse(Element e, IWarlockFactory owner)
        ...
        return new ComposeNavigateSelectorAction(owner, handle, choices, nextScreen);
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        muc.registerQuery(new ComposeMessageQuery(muc));
        muc.registerScreen(screenError);
        ...
        if (error != null) {
            ...
            rslt = new SimpleActionResponse(screen, new SelectGroupQuery(muc));
        }
        return rslt;
    }
    ...
    private ComposeNavigateSelectorAction(IWarlockFactory owner, Handle handle, String[] choices, String nextScreen) {
