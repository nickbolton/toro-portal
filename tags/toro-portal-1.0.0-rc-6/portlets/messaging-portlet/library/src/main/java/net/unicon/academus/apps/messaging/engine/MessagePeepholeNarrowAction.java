...
public final class MessagePeepholeNarrowAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public static IAction parse(Element e, IWarlockFactory owner)
        ...
        return new MessagePeepholeNarrowAction(owner, handle, choices);
    ...
    public void init(StateMachine m) {
        ...
        screen = m.getScreen(Handle.create("message_peephole_narrow"));
    }
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        return new SimpleActionResponse(screen, new MessagePeepholeNarrowQuery(muc));
    ...
    private MessagePeepholeNarrowAction(IWarlockFactory owner, Handle handle,
                                String[] choices) {
