...
public final class MessagePeepholeWideAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public static IAction parse(Element e, IWarlockFactory owner)
        ...
        return new MessagePeepholeWideAction(owner, handle, choices);
    ...
    public void init(StateMachine m) {
        ...
        screen = m.getScreen(Handle.create("message_peephole_wide"));
    }
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        return new SimpleActionResponse(screen, new MessagePeepholeWideQuery(muc));
    ...
    private MessagePeepholeWideAction(IWarlockFactory owner, Handle handle,
                                String[] choices) {
