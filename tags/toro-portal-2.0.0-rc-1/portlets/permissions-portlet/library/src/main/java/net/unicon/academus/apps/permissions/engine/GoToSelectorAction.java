...
public final class GoToSelectorAction extends PermissionsAbstractAction {
    ...
    public void init(StateMachine m) {
        ...
        nextScreen = m.getScreen(Handle.create("permissions_list"));
    }
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        puc.registerQuery(new PortletPermissionsListQuery(puc));
        puc.registerScreen(nextScreen);
        
        // set the current member selection as the previous
        puc.setPrevEntitySelection(puc.getCivisEntities());
        
        
        return new SimpleActionResponse(screen, new SelectGroupQuery(puc));        
    }
