...
<xsl:include href="common.xsl"/>
	...
	<div class="bounding-box1">
		<form action="{$baseActionURL}?command=insert_role&amp;type={$type}" method="post" name="permissionsForm" onsubmit="return validator.applyFormRules(this, new RoleAdminRulesObject());">
		...
		<tr>
			...
			<td class="table-content-right" style="text-align:left;" width="100%">
				<input class="text" type="text" name="role_name" size="35" maxlength="35" id="roleAdminTitle"></input><span class="uportal-text-small"> (35 char max)</span>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="table-nav" colspan="2">
				<input class="uportal-button" name="submit" value="Add" type="submit" title="Submit this new role"/>
				<input type="button" class="uportal-button" value="Cancel" onclick="window.locationhref='{$baseActionURL}'" title="Cancel adding this new role"/>
			</td>
		</tr>
		</table>
		</form>
