...
abstract public class SurveyScreen extends net.unicon.portal.channels.rad.Screen {



  XMLData m_data = null;

  IdentityData m_user = null;
  ...
  SurveyBoRemote getBo() throws Exception {
    ...
    if( ejb == null) {
      ...
      ejb.setFilePath(CSurvey.REPOSITORY_PATH);
