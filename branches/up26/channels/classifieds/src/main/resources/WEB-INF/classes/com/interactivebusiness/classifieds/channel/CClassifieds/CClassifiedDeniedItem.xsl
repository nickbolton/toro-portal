...
<!--
 ...
 $Log: 
  2    Channels  1.1         2/7/2002 4:58:22 PM  Jing Chai       
  1    Channels  1.0         2/6/2002 4:38:45 PM  Jing Chai       
 $
...
<xsl:template match="channel">
  <center>
  <form action="{$baseActionURL}?action=denied" method="post">  
  ...
  <tr class="uportal-background-dark" >
    <td>
      <table cellpadding="2" cellspacing="0" border="0" width="100%">
        <tr>
          <td align="left">
              <input type="submit" name="delete" value="Delete Checked" class="uportal-button"/>
          </td>
        </tr>
      </table>
    </td>
    ...
    <tr class="{$cssclass}">     
      <td width="1%" align="center">
        <input>
          ...
          <xsl:attribute name="name"><xsl:text>checkDelete_</xsl:text><xsl:value-of select="position()"/></xsl:attribute>
