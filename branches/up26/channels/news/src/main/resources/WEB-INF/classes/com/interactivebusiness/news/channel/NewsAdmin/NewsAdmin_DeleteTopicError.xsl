...
<!--
 ...
 $Log: 
  1    Channels  1.0         4/1/2002 10:36:05 AM Freddy Lopez    
 $
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:param name="pageName">NewsAdmin_DeleteTopicError</xsl:param>
			...
			<table border="0" cellpadding="4" cellspacing="0" align="center" width="100%">
				<tr>
					<td class="table-content-single">
						<span class="uportal-channel-warning">An error occured:</span> Your topic was not deleted.
					</td>
				</tr>
				<tr>
					<td class="table-content-single">
				...
				<tr>
					<td class="table-nav">
						<form action="{$baseActionURL}?action=TopicSearch&amp;admin=yes" method="post">
