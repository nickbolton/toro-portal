...
/**
 * Account information for a JavaMail Store.
 *
 * @author eandresen
 */
class EmailStoreAccount extends JavaMailAccount {

    public EmailStoreAccount(String proto) {
        super("store", proto);
    }
    ...
    public int getFeatures() {
        return Features.ATTACHMENTS|Features.SUBFOLDERS;
    }
}
