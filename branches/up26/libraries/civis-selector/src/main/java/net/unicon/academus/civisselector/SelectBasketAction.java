...
public final class SelectBasketAction extends AbstractWarlockFactory
                                                .AbstractAction {

    // Instance Members.    
    private Handle toScreen;
    ...
    public void init(StateMachine m) {
        ...
        screen = m.getScreen(Handle.create("select_basket"));        
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        return new SimpleActionResponse(screen, new SelectBasketQuery(suc));
    ...
    private SelectBasketAction(IWarlockFactory owner, Handle handle,
                                            String[] choices) {
