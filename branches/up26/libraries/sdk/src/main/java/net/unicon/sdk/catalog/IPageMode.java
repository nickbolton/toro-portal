...
/**
 * Allows <code>Catalog</code> clients to specify how many entries should appear
 * on each page and which page(s) should be included in the results of a
 * <code>Catalog.subCatalog()</code> operation.
 */
