...
/**
 * This type should probably be renamed <code>'FSimplePageMode'</code> and moved
 * to the <code>net.unicon.common.util.catalog</code> package.
 */
public final class FDbPageMode implements IPageMode {
     ...
     */
    /**
     * Creates a new <code>FDbPageMode</code> from the specified
     ...
     */
    public FDbPageMode(int pageSize, int pageNumber) {
