...
/**
 * Allows catalog clients using a <code>FDbDataSource</code> to specify the order
 * in which entries should appear.
 */
public final class FDbSortMode extends ADbMode implements ISortMode {
    /*
     * PUBLIC API
     */
    /**
     * Creates a new <code>FDbSortMode</code> from the specified sql fragment.
     *
     * @param sql a fragment of sql designed to sort the results of a 'SELECT'
     * query.
     */
    public FDbSortMode(String sql) {
        super(sql, new Object[] { });
    }
    /**
     * Creates a new <code>FDbSortMode</code> from the specified sql fragment
     ...
     */
    public FDbSortMode(String sql, Object[] params) {
        super(sql, params);
    }
}
