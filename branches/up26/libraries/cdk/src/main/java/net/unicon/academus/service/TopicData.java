    ...
    extends GroupData
{
    ...
    /** default constructor */
    public TopicData(String id, String src) {
        super(id, src);
    }

   /**
    * Constructor for a <code>TopicData</code> object.
    *
    ...
    * @param  relationData  The topic's relationships data 
    * @param  data          Extra data applicable to the topic
    *
    * @see    UCFImportAdapter
    */

    public TopicData(String groupID, String groupSource, 
