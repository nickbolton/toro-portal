...
package net.unicon.portal.security.external;
 ...
 */
public class GatewayPortalAuthentication {
    private static final Log log =
        LogFactory.getLog(GatewayPortalAuthentication.class);
    ...
    static {
        ...
        try {
            ...
            Properties props = ResourceLoader.getResourceAsProperties(
                GatewayPortalAuthentication.class,
    ...
    public static boolean authenticate(IPerson person, String username, String password) {
	    ...
	    // Log the exception
            log.error("GatewayPortalAuthenitaction unable to authenticate " +
                username, e);
            person = null;
        }
...
log.debug("Enter GatewayPortalAuthenitaction::populateTokens");
...
} // end GatewayPortalAuthentication
