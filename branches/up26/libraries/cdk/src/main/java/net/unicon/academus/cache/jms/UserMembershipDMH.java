...
public class UserMembershipDMH implements TextMessageHelper {
    ...
    throws AcademusException {
        if (JMSMessageTypeConstants.REFRESH.equals(action) &&
            ...
            executor.refreshUserMembership(username);
        } else if (JMSMessageTypeConstants.REMOVE.equals(action) &&
                   username != null) {
            // Removing user domain
            executor.removeUserMembership(username);
        }
    }
