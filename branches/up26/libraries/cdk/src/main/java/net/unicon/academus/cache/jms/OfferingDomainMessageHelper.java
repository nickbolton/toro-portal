...
public class OfferingDomainMessageHelper implements TextMessageHelper {
    ...
    /** Constructor */
    public OfferingDomainMessageHelper () { }
    ...
    public static void main (String [] args) {
        OfferingDomainMessageHelper helper = new OfferingDomainMessageHelper();
        int offeringID = 111;
        ...
        //System.out.println("Channel Data the same: " + offeringID.equals(helper.getOfferingID()));
        System.exit(1);
    }
}
