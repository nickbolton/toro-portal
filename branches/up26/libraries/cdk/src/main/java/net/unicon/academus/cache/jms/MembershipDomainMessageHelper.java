...
public class MembershipDomainMessageHelper implements TextMessageHelper {
    ...
    /** Constructor */
    public MembershipDomainMessageHelper () { }
    ...
    throws AcademusException {
        if (JMSMessageTypeConstants.REFRESH.equals(action) &&
            ...
            executor.removeMembership(offeringID);
        }
    }
    ...
    public static void main (String [] args) {
        MembershipDomainMessageHelper helper = new MembershipDomainMessageHelper();
        int offeringID = 111;
