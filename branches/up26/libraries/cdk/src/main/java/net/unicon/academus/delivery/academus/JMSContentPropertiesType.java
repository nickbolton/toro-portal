 ...
 * Consequently, all possible instances of <code>JMSContentPropertiesType</code> are
 * static members of the class itself.
 */
public class JMSContentPropertiesType extends PropertiesType {
    /* Static Members */
    public static final PropertiesType JMS =
        new JMSContentPropertiesType("/properties/jms-content.properties");
    
    private JMSContentPropertiesType(String fileName) {
        super.init(fileName);
    }
}
