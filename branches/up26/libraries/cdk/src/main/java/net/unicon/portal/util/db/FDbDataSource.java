...
/**
 * <code>IDataSource</code> implementation that pulls data from a database.
 */
public final class FDbDataSource implements IDataSource {
     ...
     */
    /**
     * Creates a new <code>FDbDataSource</code> from the specified
     * <code>queryBase</code> and <code>IDbEntryConvertor</code>.  The
     ...
     * @param ec a <code>IDbEntryConvertor</code> to use in converting
     * <code>ResultSet</code> rows into catalog entries.
     */
    public FDbDataSource(String queryBase, IDbEntryConvertor ec) {
        // Assertions.
        if (queryBase == null) {
        ...
        if (ec == null) {
            String msg = "Argument ec (IDbEntryConvertor) cannot be null.";
            throw new IllegalArgumentException(msg);
        }
        // Members.
     ...
     * <p>
     * The <code>PageMode</code> also allows the <code>FDbDataSource</code> to
    ...
    public List fetchData(ISortMode[] sorts, IFilterMode[] filters,
        ...
        try {
            ...
            for (int i = 1; rs.next(); i++) {
                rowCount = i;
                if (i < fstRow) continue;
                if (lstRow != 0 && i > lstRow) continue;
                rslts.add(ec.convertRow(rs));
            }
            // Set the pageCount.
            int pgCnt = 1;  // Default.
            if (pgSize != 0) {
            ...
            String msg = "FDbDataSource.fetchData failed.  The query was:  ";
            ...
            try {
                ...
                msg.append("FDbDataSource.fetchData failed ");
