...
public interface IOfferingSubChannel {
    // Returns a string representation (for the time being) of the XML
    // that contains all the data for this channel at the offering level
    public String exportChannel(Offering offering) throws Exception;
    // Import offering data that pertains to the channel.
