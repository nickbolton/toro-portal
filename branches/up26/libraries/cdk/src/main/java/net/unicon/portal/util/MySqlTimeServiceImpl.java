...
/*  This allows user to obtain the current date and time from the database.  We assume you have MySql setup.
 *
*/
public class MySqlTimeServiceImpl extends ADBTimeService {
    
    private static final String sysDateSQL = "SELECT now() as now";
    
    /** Constructor */
    public MySqlTimeServiceImpl() { }
