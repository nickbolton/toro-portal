 ...
 */
public class ImportServicePropertiesType extends PropertiesType {
    /* Static Members */
    public static final PropertiesType IMPORT =
        new ImportServicePropertiesType("/properties/AcademusImportService.properties");

    private ImportServicePropertiesType(String fileName) {
	    super.init(fileName);
    }
}
