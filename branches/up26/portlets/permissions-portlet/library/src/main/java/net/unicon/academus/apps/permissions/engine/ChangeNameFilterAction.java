...
public final class ChangeNameFilterAction extends PermissionsAbstractAction {
	...
	private ChangeNameFilterAction(IWarlockFactory owner, Handle handle,
			String[] choices) {
