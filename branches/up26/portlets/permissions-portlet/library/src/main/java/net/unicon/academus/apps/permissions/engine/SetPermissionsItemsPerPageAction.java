...
public final class SetPermissionsItemsPerPageAction extends PermissionsAbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        // Find & set the value.
        String value = decisions[0].getDecision("chooseDisplayNumber").getFirstSelectionHandle();
        puc.getPermissionsPaging().setItemsPerPage(Integer.parseInt(value));
    ...
    private SetPermissionsItemsPerPageAction(IWarlockFactory owner, Handle handle,
                                            String[] choices) {
