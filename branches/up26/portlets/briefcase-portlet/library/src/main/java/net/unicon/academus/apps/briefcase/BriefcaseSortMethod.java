...
public class BriefcaseSortMethod {
    ...
    public static final BriefcaseSortMethod NAME_ASCENDING  
    								= new BriefcaseSortMethod("name", "asc", 0);
    public static final BriefcaseSortMethod NAME_DESCENDING 
    								= new BriefcaseSortMethod("name", "des", 1);
    public static final BriefcaseSortMethod DATE_ASCENDING  
    								= new BriefcaseSortMethod("date", "asc", 2);
    public static final BriefcaseSortMethod DATE_DESCENDING 
    								= new BriefcaseSortMethod("date", "des", 3);
    public static final BriefcaseSortMethod TYPE_ASCENDING  
    								= new BriefcaseSortMethod("type", "asc", 4);
    public static final BriefcaseSortMethod TYPE_DESCENDING 
    								= new BriefcaseSortMethod("type", "des", 5);
    public static final BriefcaseSortMethod SIZE_ASCENDING  
    								= new BriefcaseSortMethod("size", "asc", 6);
    public static final BriefcaseSortMethod SIZE_DESCENDING 
    								= new BriefcaseSortMethod("size", "des", 7);

    public static BriefcaseSortMethod getInstance(String handle) {
        ...
        return (BriefcaseSortMethod) instances.get(handle);

    }

    public static BriefcaseSortMethod reverse(BriefcaseSortMethod method) {
    ...
    private BriefcaseSortMethod(String mode, String direction, int switchable) {
