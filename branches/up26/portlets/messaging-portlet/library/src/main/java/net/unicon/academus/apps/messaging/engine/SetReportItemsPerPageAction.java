...
public final class SetReportItemsPerPageAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        muc.getDetailPref().getReportPageState().setItemsPerPage(Integer.parseInt(value));
    ...
    private SetReportItemsPerPageAction(IWarlockFactory owner, Handle handle,
                                            String[] choices) {
