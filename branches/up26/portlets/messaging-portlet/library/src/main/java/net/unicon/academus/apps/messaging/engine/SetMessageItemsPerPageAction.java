...
public final class SetMessageItemsPerPageAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        muc.getMessagePaging().setItemsPerPage(Integer.parseInt(value));
    ...
    private SetMessageItemsPerPageAction(IWarlockFactory owner, Handle handle,
                                            String[] choices) {
