...
public final class MessageReportViewAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        muc.getDetailPref().setMode("report");
    ...
    private MessageReportViewAction(IWarlockFactory owner, Handle handle, String[] choices) {
