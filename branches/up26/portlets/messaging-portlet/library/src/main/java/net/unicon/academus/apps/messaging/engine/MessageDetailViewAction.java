...
public final class MessageDetailViewAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public static IAction parse(Element e, IWarlockFactory owner)
        ...
        return new MessageDetailViewAction(owner, handle, choices);
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        muc.getDetailPref().setMode("details");
    ...
    private MessageDetailViewAction(IWarlockFactory owner, Handle handle, String[] choices) {
