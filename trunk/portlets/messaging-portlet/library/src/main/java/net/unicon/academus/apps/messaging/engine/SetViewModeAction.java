...
public final class SetViewModeAction extends AbstractWarlockFactory
                                                .AbstractAction {
    ...
    public IActionResponse invoke(IDecisionCollection[] decisions,
        ...
        String d = decisions[0].getDecision("viewFilter").getFirstSelectionHandle();

        ViewMode m = ViewMode.getInstance(d);
        muc.setViewMode(m);
    ...
    private SetViewModeAction(IWarlockFactory owner, Handle handle, String[] choices) {
