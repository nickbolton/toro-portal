 ...
 */
public class ClientOrganizationStub {
    ...
    private int entityAccessLevel;
    public int getEntityAccessLevel() { return entityAccessLevel; }
    public void setEntityAccessLevel(int entityAccessLevel) { this.entityAccessLevel = entityAccessLevel; }
