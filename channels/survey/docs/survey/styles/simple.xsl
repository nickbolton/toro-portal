...
<xsl:template match='page' name='form'>
  ...
  <xsl:if test='@title'>
    <font class='uportal-channel-title'><xsl:value-of select='@title'/></font><br/>
  </xsl:if>
  <table cellpadding='3' cellspacing='0'>
    <xsl:for-each select='question'>
      <tr>
        <td valign='top' class='uportal-channel-subtitle'><xsl:value-of select='@question-id'/></td>
        <td>
...
<xsl:template name='statistics'>
  ...
  <td width='45' align='right' class='uportal-background-light'>&#160;<font class='uportal-channel-text'><xsl:value-of select='$number-responses'/></font>&#160;</td>
  <td width='45' align='right' class='uportal-background-med'>&#160;<font class='uportal-channel-text'><xsl:value-of select='$percent'/></font>&#160;</td>
</xsl:template>
